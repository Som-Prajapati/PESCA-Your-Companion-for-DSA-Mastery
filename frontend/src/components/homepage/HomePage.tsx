  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <Head>
        ...
        <meta
          name="description"
          content="Interactive platform for learning algorithms through visualization and practice"
        />
      ...
      <div ref={heroRef} className="pt-32 pb-20 px-6 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10">
          Learn complex algorithms with interactive animations, practice with
          real coding problems, and track your progress all in one place.
        </p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Understand how algorithms work through interactive animations.
                Watch step-by-step executions of sorting, searching, and other
                complex algorithms.
              </p>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Practice with Our Code Editor
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Apply what you've learned by solving problems in our integrated
                code editor. Get instant feedback and improve your skills.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center">
                  <div className="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center mr-3">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-700">
                    Test cases and challenge problems
                  </span>
                </li>
              </ul>
              <Link href="/practice">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Monitor your learning journey with detailed analytics. See which
                algorithms you've mastered and where you need more practice.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center">
                  <div className="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center mr-3">
                  ...
                  <span className="text-gray-700">
                    Completion tracking for each algorithm
                  </span>
                </li>
                <li className="flex items-center">
                  <div className="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center mr-3">
      ...
      <footer className="bg-gray-900 text-gray-300 py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">
              Master algorithms through visualization and practice.
            </p>
          </div>
          <div>
